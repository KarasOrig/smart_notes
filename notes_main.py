...
notes = {
    ...
    "Эдд ноут" : {
        "текст" : "фывфывфывфывфывфывфывфыв",
        "теги" : [] 
    },
    "asdasdasd" : {
        "текст" : "",
...
#расположение виджетов по шампурам
shampur_notes = QHBoxLayout()
col_1 = QVBoxLayout()
...
shampur_notes.addLayout(col_1, stretch = 2)
shampur_notes.addLayout(col_2, stretch = 1)
notes_win.setLayout(shampur_notes)
